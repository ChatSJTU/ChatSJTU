        ...
        <Layout style={{ height: '100vh', background: '#FFF', position : 'relative'}}>
            <div style={{background: '#FFF', position : 'relative'}}>
                ...
                <div style={{ display: 'flex', 
                    ...
                    <Typography style={{margin:'0px 25px', display: 'flex', 
                        ...
                        <Paragraph style={{ fontSize:'20px', marginTop: 14, textAlign : 'center'}}>由生成式人工智能技术驱动，为交大师生学习科研赋能</Paragraph>
                    </Typography>
            ...
            <Footer style={{background: '#FFF', padding : '0'}}>
                <div
                    ...
                    <p style={{fontSize: '12px', color: '#aaaaaa', letterSpacing: '0.3px'}}>版权所有 © 2023 上海交通大学网络信息中心 沪交ICP备20230139<br/>技术支持：ChatSJTU 学生开发团队 <a href="mailto:gpt@sjtu.edu.cn">联系我们</a></p>
                </div>
            </Footer>
        </Layout>
    )
